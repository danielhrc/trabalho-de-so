...
public class Tests {
    ...
    public void criaPedidoTest(){
     ...
     //maximar a quantidade de pacotes antes do meio dia
    }
    ...
    public void horarioTest(){
     ...
     //testar o tempo de empacotamento de cada produto
        ...
        //testar tempo do braço robotico de 0,5 após fim do pacote
        //testar para minimizar o tempo de proudução de pacotes
    }
